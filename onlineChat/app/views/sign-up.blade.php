...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="javascript:void(0);" style="text-decoration:none; float:left;"><h2 class="vpb_wall_logo"><img src="../logo/logo-vasplus.png" border="0" title="Vasplus Programming Blog" alt="Vasplus Programming Blog"></h2></a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="login.html"><i class="fa fa-sign-in"></i> Login</a></li><li><a href="#"><i class="fa fa-home"></i> Home</a></li></ul>     		</div>
    </div>
</nav>
<!-- Navigation Ends -->
                            ...
                            <div class="vpb_submit_data_wrap"  style="margin-right:0px; padding-bottom:15px;">
                                ...
                                <center>
                                    <div class="vthe_buttons" id="signup_buttons">
                                        ...
                                        <div onClick="window.location.href='login.html';" class="sbtn vthe_button">Back to Login</div>
