                    ...
                    <div class="vpb_left_page" style="float:none; margin:0 auto;margin-bottom:10px;" align="left">
                        <div id="disable_or_enable_this_box" class="enable_this_box">
                            ...
                            <div style=" padding:15px;" align="center">
                                ...
                                <input type="hidden" name="ue_data" id="ue_data" value={{$username}}>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" style="min-width:100%;border-radius: 0px 4px 0px 0px;" class="form-control" name="new_pass" id="new_pass" value="" data-placement="top" autocomplete="off" placeholder="New Password "  required>
                                </div>
                                ...
                                <div class="input-group">
                                    <span style="border-radius: 4px 0px 0px 0px;" class="input-group-addon"><i class="fa fa-lock"></i></span>
                                    <div id="wrond_details" data-placement="top" align="center" style="width:100%;"></div>
                                    <input type="password" style="min-width:100%;border-radius: 0px 4px 0px 0px;" class="form-control" name="verify_pass" id="verify_pass" value="" data-placement="top" autocomplete="off" placeholder="Verify New Password "  required>
                                </div>
                                ...
                                <div class="vpb_submit_data_wrap"  style="margin-right:0px; padding-bottom:15px;">
                                    ...
                                    <center>
                                        <div class="vthe_buttons" id="forgot_password_buttoned">
                                            <div onClick="vpb_change_password_now();" class="sbtn-success vthe_button">Submit</div>

                                            <div onClick="window.location.href='login';" class="sbtn vthe_button">Back to Login</div>
