...
<div class="vprofile_about_detail" id="page_fullname_text" style="display:none;">
    <div class="vmiddle_about_title">Fullname</div>
    <div class="vprofile_about_desc">
       {{$fullname}}</div>
</div>

<div id="page_fullname_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="page_username_text" style="display:none;">
...
<div id="page_fullname_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    ...
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="epage_username" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="{{$username}}">
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="page_country_text" style="display:none;">
    <div class="vmiddle_about_title">Country</div>
    <div class="vprofile_about_desc">
        Nepal            </div>
</div>

<div id="page_country_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
