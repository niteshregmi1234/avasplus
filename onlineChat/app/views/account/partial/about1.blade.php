...
<div class="vprofile_about_detail" id="page_fullname_text" style="min-width:100%;display:inline-block;">
    <div class="vmiddle_about_title">Fullname</div>
    <div class="vprofile_about_desc">
        {{$fullname}}</div>
</div>

<div id="page_fullname_html" style="min-width:100%;display:none;">
    <span class="input-group-addon vprofile_about_detail_addon">Fullname</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="epage_fullname" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="{{$fullname}}">
...
<div id="page_email_html" style="min-width:100%;display:none;">
    <span class="input-group-addon vprofile_about_detail_addon">Email Address</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="epage_email" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="{{$email}}">
...
<div class="vprofile_about_detail" id="about_us_text" style="display:none;">
    <div class="vmiddle_about_title">About {{explode(" ",$fullname)[0]}}</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="about_us_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    ...
    <textarea style="border-radius: 0px;" class="form-control" id="eabout_us" placeholder="Write brief introduction about your self..." autocomplete="off" autocorrect="off" autocapitalize="off"></textarea>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="favorite_quotes_text" style="display:none;">
    <div class="vmiddle_about_title">Favorite Quotes</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="favorite_quotes_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    ...
    <textarea style="border-radius: 0px; " class="form-control" id="efavorite_quotes" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off"></textarea>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="marital_status_text" style="display:none;">
    <div class="vmiddle_about_title">Relationship Status</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="marital_status_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="address_text" style="display:none;">
    <div class="vmiddle_about_title">Address</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="address_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    ...
    <textarea style="border-radius: 0px; " class="form-control" id="eaddress" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off"></textarea>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="phone_text" style="display:none;">
    <div class="vmiddle_about_title">Phone Number(s)</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="phone_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What are your phone number(s)?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ephone" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="gender_text" style="display:none;">
    <div class="vmiddle_about_title">Gender</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="gender_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="interested_in_text" style="display:none;">
    <div class="vmiddle_about_title">Interested in</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="interested_in_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="birth_date_text" style="display:none;">
    <div class="vmiddle_about_title">Birthday</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="birth_date_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="company_text" style="display:none;">
    <div class="vmiddle_about_title">Works at</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="company_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">Where do you currently work?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ecompany" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="job_position_text" style="display:none;">
    <div class="vmiddle_about_title">Job Position</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="job_position_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What is your current job position?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ejob_position" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="professional_skill_text" style="display:none;">
    <div class="vmiddle_about_title">Professional Skill(s)</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="professional_skill_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What professional skills do you have?</span>
    <textarea style="border-radius: 0px;" class="form-control" id="eprofessional_skill" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off"></textarea>
</div>
...
<div class="vprofile_about_detail" id="high_school_name_text" style="display:none;">
    <div class="vmiddle_about_title">High School</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="high_school_name_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">Add a High School</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ehigh_school_name" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="started_high_school_from_date_text" style="display:none;">
    <div class="vmiddle_about_title">Date stated High School</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="started_high_school_from_date_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="ended_high_school_at_date_text" style="display:none;">
    <div class="vmiddle_about_title">Date ended High School</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="ended_high_school_at_date_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="college_field_of_study_text" style="display:none;">
    <div class="vmiddle_about_title">Field of Study</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="college_field_of_study_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What's your field of study?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ecollege_field_of_study" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="college_name_text" style="display:none;">
    <div class="vmiddle_about_title">College</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="college_name_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What's the name of your college?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ecollege_name" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="started_college_from_date_text" style="display:none;">
    <div class="vmiddle_about_title">Date stated College</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="started_college_from_date_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="ended_college_at_date_text" style="display:none;">
    <div class="vmiddle_about_title">Date ended College</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="ended_college_at_date_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="from_city_name_text" style="display:none;">
    <div class="vmiddle_about_title">From</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="from_city_name_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">Which city are you from?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="efrom_city_name" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="lives_in_city_name_text" style="display:none;">
    <div class="vmiddle_about_title">Lives in</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="lives_in_city_name_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">In which city do you currently live?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="elives_in_city_name" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="language_text" style="display:none;">
    <div class="vmiddle_about_title">Primary Language</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="language_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
...
<div class="vprofile_about_detail" id="religion_text" style="display:none;">
    <div class="vmiddle_about_title">Religious Views</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="religion_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What's your Religious Views?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="ereligion" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">
...
<div class="vprofile_about_detail" id="politicl_view_text" style="display:none;">
    <div class="vmiddle_about_title">Political Views</div>
    <div class="vprofile_about_desc">
        <font style="color:#999;">No information provided yet</font>            </div>
</div>

<div id="politicl_view_html" style="display:inline-block;min-width:100% !important;width:100% !important;">
    <span class="input-group-addon vprofile_about_detail_addon">What are your Political Views?</span>
    <input style="border-radius: 0px 0px 0px 0px;" type="text" class="form-control" id="epoliticl_view" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="">
    <div style="clear:both;"></div>
</div>
<br clear="all"><br clear="all">


<div class="vprofile_about_detail" id="page_country_text" style="min-width:100%;display:inline-block;">
    <div class="vmiddle_about_title">Country</div>
    <div class="vprofile_about_desc">
        Nepal            </div>
</div>

<div id="page_country_html" style="min-width:100%;display:none;">
    ...
    <select id="ecountry" style="min-width: 100%;" >
        <option value="Nepal" selected="">Nepal</option>            <option value="">Select your country</option>
