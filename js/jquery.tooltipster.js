...
Modified by Vasplus Programming Blog!
*/
...
! function(t, o, e) {
    function i(o, e) {
        this.bodyOverflowX, this.callbacks = {
            hide: [],
            show: []
        }, this.checkInterval = null, this.Content, this.$el = t(o), this.$elProxy, this.elProxyPosition, this.enabled = !0, this.options = t.extend({}, a, e), this.mouseIsOverProxy = !1, this.namespace = "vpb_tooltips-" + Math.round(1e5 * Math.random()), this.Status = "hidden", this.timerHide = null, this.timerShow = null, this.$tooltip, this.options.iconTheme = this.options.iconTheme.replace(".", ""), this.options.theme = this.options.theme.replace(".", ""), this._init()
    }
    ...
    i.prototype = {
        _init: function() {
            ...
            if (e.querySelector) {
                var i = null;
                void 0 === o.$el.data("vpb_tooltips-initialTitle") && (i = o.$el.attr("title"), void 0 === i && (i = null), o.$el.data("vpb_tooltips-initialTitle", i)), null !== o.options.content ? o._content_set(o.options.content) : o._content_set(i);
                var n = o.options.functionInit.call(o.$el, o.$el, o.Content);
                "undefined" != typeof n && o._content_set(n), o.$el.removeAttr("title").addClass("vpb_tooltipsed"), !p && o.options.iconDesktop || p && o.options.iconTouch ? ("string" == typeof o.options.icon ? (o.$elProxy = t('<span class="' + o.options.iconTheme + '"></span>'), o.$elProxy.text(o.options.icon)) : o.options.iconCloning ? o.$elProxy = o.options.icon.clone(!0) : o.$elProxy = o.options.icon, o.$elProxy.insertAfter(o.$el)) : o.$elProxy = o.$el, "hover" == o.options.trigger ? (o.$elProxy.on("mouseenter." + o.namespace, function() {
        ...
        _showNow: function(e) {
            ...
            i.options.functionBefore.call(i.$el, i.$el, function() {
                if (i.enabled && null !== i.Content) {
                    e && i.callbacks.show.push(e), i.callbacks.hide = [], clearTimeout(i.timerShow), i.timerShow = null, clearTimeout(i.timerHide), i.timerHide = null, i.options.onlyOne && t(".vpb_tooltipsed").not(i.$el).each(function(o, e) {
                        var i = t(e),
                            n = i.data("vpb_tooltips-ns");
                    ...
                    if ("hidden" !== i.Status) {
                        var s = 0;
                        "disappearing" === i.Status ? (i.Status = "appearing", r() ? (i.$tooltip.clearQueue().removeClass("vpb_tooltips-dying").addClass("vpb_tooltips-" + i.options.animation + "-show"), i.options.speed > 0 && i.$tooltip.delay(i.options.speed), i.$tooltip.queue(n)) : i.$tooltip.stop().fadeIn(n)) : "shown" === i.Status && n()
                    } else {
                        i.Status = "appearing";
                        var s = i.options.speed;
                        i.bodyOverflowX = t("body").css("overflow-x"), t("body").css("overflow-x", "hidden");
                        var l = "vpb_tooltips-" + i.options.animation,
                            ...
                            v = i.$el.attr("c"),
                            $ = i.$el.attr("rel");
                        if (i.$tooltip = t('<div rel="' + $ + '" c="' + v + '" id="vasplus_1982' + m + '" class="vpb_likesBox vpb_tooltips-base ' + i.options.theme + '" style="' + f + " " + d + " " + c + " " + a + '"><div class="vpb_tooltips-content"></div></div>'), r() && i.$tooltip.addClass(l), i._content_insert(), i.$tooltip.appendTo("body"), i.reposition(), i.options.functionReady.call(i.$el, i.$el, i.$tooltip), r() ? (i.$tooltip.addClass(l + "-show"), i.options.speed > 0 && i.$tooltip.delay(i.options.speed), i.$tooltip.queue(n)) : i.$tooltip.css("display", "none").fadeIn(i.options.speed, n), i._interval_set(), t(o).on("scroll." + i.namespace + " resize." + i.namespace, function() {
                                i.reposition()
                            }), i.options.autoClose)
        ...
        _content_insert: function() {
            var t = this,
                o = this.$tooltip.find(".vpb_tooltips-content");
        ...
        _update: function(t) {
            ...
            }).addClass("vpb_tooltips-content-changing"), setTimeout(function() {
                "hidden" != o.Status && (o.$tooltip.removeClass("vpb_tooltips-content-changing"), setTimeout(function() {
        ...
        hide: function(e) {
            ...
            if ("shown" == i.Status || "appearing" == i.Status) {
                ...
                r() ? (i.$tooltip.clearQueue().removeClass("vpb_tooltips-" + i.options.animation + "-show").addClass("vpb_tooltips-dying"), i.options.speed > 0 && i.$tooltip.delay(i.options.speed), i.$tooltip.queue(s)) : i.$tooltip.stop().fadeOut(i.options.speed, s)
        ...
        reposition: function() {
            ...
            if (0 !== t("body").find(n.$tooltip).length) {
                ...
                if (n.options.arrow) {
                    var F = "vpb_tooltips-arrow-" + D;
                    if (n.options.arrowColor.length < 1) var N = n.$tooltip.css("background-color");
                    else var N = n.options.arrowColor;
                    if (s ? "left" == s ? (F = "vpb_tooltips-arrow-right", s = "") : "right" == s ? (F = "vpb_tooltips-arrow-left", s = "") : s = "left:" + Math.round(s) + "px;" : s = "", "top" == D || "top-left" == D || "top-right" == D) var X = parseFloat(n.$tooltip.css("border-bottom-width")),
                    ...
                    if (0 !== X) {
                        var E = "",
                            L = "border-color: " + q + ";"; - 1 !== F.indexOf("bottom") ? E = "margin-top: -" + Math.round(X) + "px;" : -1 !== F.indexOf("top") ? E = "margin-bottom: -" + Math.round(X) + "px;" : -1 !== F.indexOf("left") ? E = "margin-right: -" + Math.round(X) + "px;" : -1 !== F.indexOf("right") && (E = "margin-left: -" + Math.round(X) + "px;"), j = '<span class="vpb_tooltips-arrow-border" style="' + E + " " + L + ';"></span>'
                    }
                    n.$tooltip.find(".vpb_tooltips-arrow").remove();
                    var Q = '<div class="' + F + ' vpb_tooltips-arrow" style="' + s + '">' + j + '<span style="border-color:' + N + ';"></span></div>';
                    n.$tooltip.append(Q)
                }
                n.$tooltip.css({
                    top: Math.round(O) + "px",
        ...
        destroy: function() {
            ...
            var e = o.$el.data("vpb_tooltips-ns");
            if (1 === e.length) {
                var i = null;
                "previous" === o.options.restoration ? i = o.$el.data("vpb_tooltips-initialTitle") : "current" === o.options.restoration && (i = "string" == typeof o.Content ? o.Content : t("<div></div>").append(o.Content).html()), i && o.$el.attr("title", i), o.$el.removeClass("vpb_tooltipsed").removeData("vpb_tooltips-ns").removeData("vpb_tooltips-initialTitle")
            } else e = t.grep(e, function(t, e) {
                return t !== o.namespace
            }), o.$el.data("vpb_tooltips-ns", e);
            return o
        },
        ...
        if ("string" == typeof o[0]) {
            ...
            return this.each(function() {
                var e = t(this).data("vpb_tooltips-ns"),
                    i = e ? t(this).data(e[0]) : null;
                if (!i) throw new Error("You called vpb_tooltips's \"" + o[0] + '" method on an uninitialized element');
                if ("function" != typeof i[o[0]]) throw new Error('Unknown method .vpb_tooltips("' + o[0] + '")');
                var s = i[o[0]](o[1], o[2]);
        ...
        return this.each(function() {
            var e = !1,
                n = t(this).data("vpb_tooltips-ns"),
                r = null;
            n ? l ? e = !0 : f && console.log('vpb_tooltips: one or more tooltips are already attached to this element: ignoring. Use the "multiple" option to attach more tooltips.') : e = !0, e && (r = new i(this, o[0]), n || (n = []), n.push(r.namespace), t(this).data("vpb_tooltips-ns", n), t(this).data(r.namespace, r)), s.push(r)
        }), l ? s : this
    };
